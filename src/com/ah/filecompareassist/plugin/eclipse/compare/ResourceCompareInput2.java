 ...
 *     Jason.Y.Lin (linxux.hz@gmail.com) - Copy from {@link org.eclipse.compare.internal.ResourceCompareInput}, modify the method showCompareWithOtherResourceDialog(): use {@link CompareWithOtherResourceDialog2} instead of {@link CompareWithOtherResourceDialog}
 *******************************************************************************/
 ...
 */
public class ResourceCompareInput2 extends CompareEditorInput {
	 ...
	 */
	public ResourceCompareInput2(CompareConfiguration config) {
		super(config);
	}
	...
	// true otherwise.
	public boolean setSelection(ISelection s, Shell shell, boolean showSelectAncestorDialog) {
	...
	private boolean showCompareWithOtherResourceDialog(Shell shell, ISelection s) {
		CompareWithOtherResourceDialog2 dialog = new CompareWithOtherResourceDialog2(shell, s);
